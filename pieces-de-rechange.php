...
?>
<main class="main">
  <div class="page-title light-background"><div class="container d-lg-flex justify-content-between align-items-center"><h1 class="mb-2 mb-lg-0">Pièces de rechange</h1><nav class="breadcrumbs" aria-label="Fil d’Ariane"><ol><li><a href="index.php">Accueil</a></li><li><a href="catalogue.php">Catalogue</a></li><li class="current">Pièces de rechange</li></ol></nav></div></div>
  <section class="starter-section section"><div class="container section-title" data-aos="fade-up"><h2>Pièces et composants</h2><p>Les pièces de rechange seront chargées automatiquement depuis la future base de données et organisées par marque, équipement et référence.</p></div><div class="container text-center"><i class="bi bi-tools display-1 text-success"></i><p class="mt-3">Aucun produit ni prix provisoire n’est affiché en dur. Le catalogue sera alimenté automatiquement à partir de la base de données.</p><a href="demande-devis.php" class="btn btn-primary">Demander une pièce</a></div></section>
</main>
