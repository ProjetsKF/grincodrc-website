<?php
$catalogueCategoryName = 'Pièces de rechange';
$cataloguePagePath = '/pieces-de-rechange';
...
<main class="main">
  ...
  <section class="catalogue-products section"><div class="container section-title" data-aos="fade-up"><h2>Pièces et composants</h2><p>Consultez les pièces de rechange actuellement disponibles auprès de GRINCO RDC.</p></div><div class="container"><?php include __DIR__ . '/includes/catalogue-grid.php'; ?></div></section>
</main>
