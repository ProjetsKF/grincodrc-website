<?php
$catalogueCategoryName = 'Camions';
$cataloguePagePath = '/camions';
...
<main class="main">
  ...
  <section class="catalogue-products section"><div class="container section-title" data-aos="fade-up"><h2>Catalogue de camions</h2><p>Découvrez les camions actuellement disponibles auprès de GRINCO RDC.</p></div><div class="container"><?php include __DIR__ . '/includes/catalogue-grid.php'; ?></div></section>
</main>
